...
class DreamerMemory:
    ...
    def sample1(self, batch_size):
        return self.get_transitions1(self.sample_positions(batch_size))

    def sample2(self, batch_size):
        return self.get_transitions2(self.sample_positions(batch_size))
    ...
    def get_transitions1(self, idxs):
        batch_size = len(idxs)
    ...
    def get_transitions2(self, idxs):
        ...
        return {'observation': observation, 'reward': reward, 'action': action, 'done': done,   #'global_state': global_state,
                'fake': fake, 'last': last, 'av_action': av_action}
